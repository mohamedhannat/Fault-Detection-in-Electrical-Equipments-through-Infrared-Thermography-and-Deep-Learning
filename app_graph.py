...
"}")
   ...
   def display_image_first(self):
      ...
      rgb_name=a.split("/")
      rgb_name=rgb_name[5].split(".")
      rgb_name='rgb/'+rgb_name[0]+'.jpg'
      print(rgb_name)
   ...
   def process_game(self):
      ...
      subprocess.call("python detect.py --weights  best.pt --conf 0.6 --img-size 416 --save-txt --source "+self.get_image_name(), shell=True)
      a="save.jpg"
   ...
   def display_2(self):
      ...
      subprocess.call("python detect.py --weights  runs/train/yolov721/weights/best.pt --conf 0.6 --img-size 416 --save-txt --source "+self.get_image_name(), shell=True)
      a="save.jpg"
